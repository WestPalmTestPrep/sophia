...
export const wordEntries: WordEntry[] = [
  ...
  { id: '10', text: 'MIA → WPB',                                      size: 'sm', weight: 'bold',   style: 'sans' },
  { id: '11', text: 'NYC',                                             size: 'sm', weight: 'bold',   style: 'sans' },
  ...
  { id: '19', text: 'curated to be so uncurated',                      size: 'md', weight: 'light',  style: 'serif' },
  { id: '20', text: 'Pavlatos',                                        size: 'sm', weight: 'bold',   style: 'serif' },
  { id: '21', text: 'self starter',                                    size: 'sm', weight: 'normal', style: 'sans' },
  { id: '22', text: 'no safety net',                                   size: 'xs', weight: 'light',  style: 'serif' },
  { id: '23', text: '@sophitness_',                                     size: 'sm', weight: 'bold',   style: 'sans' },
  { id: '24', text: 'cozy girl',                                       size: 'sm', weight: 'light',  style: 'serif' },
  { id: '25', text: 'never skips leg day',                             size: 'xs', weight: 'normal', style: 'sans' },
];
