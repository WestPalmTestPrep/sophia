...
export const UNLOCKABLE_SQUARES: BoardSquare[] = [
  ...
  { row: 1, col: 6, section: 'messages',      label: 'PAV Wrapped',       icon: '◉' },
  { row: 3, col: 3, section: 'timeline',      label: 'Spin the Wheel',   icon: '◈' },
  { row: 3, col: 4, section: 'achievements',  label: 'Achievements',      icon: '◇' },
  { row: 5, col: 2, section: 'moodboard',     label: 'Mood Board',        icon: '◬' },
  { row: 5, col: 5, section: 'sophietok',     label: 'SophieTok',         icon: '◮' },
