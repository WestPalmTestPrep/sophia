...
const GIFTS: Gift[] = [
  {
    ...
    ribbonColor: '#d4af37',
    pattern: 'none',
    message: 'You\'re officially a Stamatakis in July. No refunds.',
  ...
  },
  {
    ...
    message: 'A wedding in Greece. A Pavlatos homecoming. I\'m just here for the food honestly.',
  ...
  },
  {
    ...
    message: 'You moved to Florida and built three businesses. I moved to my couch and built this website. We are not the same.',
    subtitle: 'Humbling',
    emoji: '👑',
  },
  {
    ...
    ribbonColor: '#f87171',
    pattern: 'none',
    message: 'Post a story right now saying "My brother-in-law built me a website and it\'s better than yours." Do it. I dare you.',
  ...
  },
  {
    ...
    message: 'Real talk — my brother\'s lucky. You\'re good people, Sophia. Happy Birthday.',
    subtitle: 'Serious For One Second',
    emoji: '♥',
  },
  {
    id: '6',
    ...
    ribbonColor: '#d4af37',
    pattern: 'none',
    message: 'Vogue quoted you. VOGUE. Meanwhile I\'m out here getting quoted by nobody. Respect.',
